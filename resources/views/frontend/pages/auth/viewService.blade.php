...
<style type="text/css">
    ...
    <div class="container pt-5" style="text-align: center;margin-bottom:20px">
    <h1 style="padding: 30px 0;">Single Service View </h1>

            <div class="card" style="margin: 0 auto;">
                <div class="top-design"></div>
                <div class="card-body"><img
                    src="{{url('/upload/'.$services->image)}}" alt="" class="avatar" style="margin:0 auto;height:200px;width:200px">
                    <div>
                        <h2>{{$services->service_name}}</h2> <span class="text-muted">
                    ...
                    <a href="{{route('frontend.service')}}"><button class="btn btn-warning" aria-describedby="myBtn">Back</button></a>
                    </div>
                    <div class="bg-b"></div>
                </div>
