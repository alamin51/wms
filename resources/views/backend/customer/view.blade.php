        ...
        <div class="row justify-content-center">
            <div class="card">
                ...
                <div class="card-body"><img
                    src="{{url('/upload/'.$customers->picture)}}" alt="" class="avatar">
                    <div class="user-info">
                        <h3>{{$customers->event_name}}</h3> <span class="text-muted">
                    ...
                    <a href="{{route('event.create.table')}}"><button class="btn addBtn form-control" aria-describedby="myBtn">Back</button></a>
                    </div>
                    <div class="bg-b"></div>
                </div>
